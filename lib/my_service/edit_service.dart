...
class EditService extends StatefulWidget {
  const EditService({super.key, required this.editService1});
  final EditDetails editService1;
...
class _EditServiceState extends State<EditService> {
  ...
  @override
   void initState(){
    super.initState();
    _controllername.text=widget.editService1.name;
    _controllerprice.text=widget.editService1.price;
    _controllerdiscount.text=widget.editService1.discount;
    _controllerduration.text=widget.editService1.time.toString();
  }
//   /////////////////////////////////////////////////
          ...
          child: Column(
            ...
            children: [
              ...
              _images.isNotEmpty
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      image: DecorationImage(image: AssetImage(widget.editService1.image),fit: BoxFit.cover),
                      borderRadius: BorderRadius.circular(8)),
                  child: const Icon(
              ...
              TextFormField(
                ...
                onChanged: (value){
                  setState(() {
                    widget.editService1.name=value;
                  });
                },
              ...
              TextFormField(
                ...
                onChanged: (value){
                  setState(() {
                    widget.editService1.price=value;
                  });
                },
                style:textTheme.titleMedium,
                decoration: InputDecoration(
              ...
              TextFormField(
                ...
                onChanged: (value){
                  setState(() {
                    widget.editService1.discount=value;
                  });
                },
                style:textTheme.titleMedium,
                decoration: InputDecoration(
              ...
              TextFormField(
                ...
                onChanged: (value){
                  widget.editService1.time = int.tryParse(value) ?? 0;
                },
                style:textTheme.titleMedium,
                decoration: InputDecoration(
                  labelText: 'Duration ',
